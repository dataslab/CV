...
wordname_16 = ('plane', 'baseball-diamond',
...
wordname_11 = ("A","B","C","D","E","F","G","H","I","J","K")
#label_ids = {name: i + 1 for i, name in enumerate(wordname_15)}
label_ids = {name: i + 1 for i, name in enumerate(wordname_11)}
...
#    convert_dota_to_mmdet('data/dota_1024/test_split',
  #                       'data/dota_1024/test_split/test_s2anet.pkl', trainval=False)
    #mydota
 #   convert_dota_to_mmdet('/home/songhetian/dataset/DOTAV1.5/dota1_5-split-1024/trainval1024',
  #                      '/home/songhetian/dataset/DOTAV1.5/dota1_5-split-1024/trainval1024/trainval_s2anet.pkl')
  
    convert_dota_to_mmdet('/home/songhetian/dataset/airplaneDOTA/airplane-split-1024/trainval1024_ms',
                        '/home/songhetian/dataset/airplaneDOTA/airplane-split-1024/trainval1024_ms/trainval_s2anet.pkl')
  
    convert_dota_to_mmdet('/home/songhetian/dataset/airplaneDOTA/airplane-split-1024/val1024',
                        '/home/songhetian/dataset/airplaneDOTA/airplane-split-1024/val1024/val_s2anet.pkl')
